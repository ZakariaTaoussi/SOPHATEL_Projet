...
@Component
public class ResponsableEmployeMapper {

    public ResponsableEmployeResponse toResponse(Employe employe, SoldeConge solde, Integer anneeSolde) {
        ...
        return new ResponsableEmployeResponse(
