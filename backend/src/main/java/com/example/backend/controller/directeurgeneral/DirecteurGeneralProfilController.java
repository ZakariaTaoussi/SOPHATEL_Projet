...
@RestController
@RequestMapping("/api/directeur-general/profil")
public class DirecteurGeneralProfilController {

    private final IProfilService profilService;

    public DirecteurGeneralProfilController(IProfilService profilService) {
